...
usuarioId_FK INT UNSIGNED NOT NULL,
CONSTRAINT FK_UsuarioAluno FOREIGN KEY (usuarioId_FK) REFERENCES Usuarios_TB(usuarioId));
...
usuarioId_FK INT UNSIGNED NOT NULL,
CONSTRAINT FK_UsuarioFunc FOREIGN KEY (usuarioId_FK) REFERENCES Usuarios_TB(usuarioId));
